...
export const MOCK_RUNS: Run[] = [
  { run_id: 'run-20231025-001', timestamp: '2023-10-25T08:00:00Z', status: 'completed', total_findings: 12 },
  { run_id: 'run-20231026-001', timestamp: '2023-10-26T08:00:00Z', status: 'completed', total_findings: 15 },
  { run_id: 'run-20231027-001', timestamp: '2023-10-27T08:00:00Z', status: 'completed', total_findings: 8 },
  { run_id: 'run-20231028-001', timestamp: '2023-10-28T08:00:00Z', status: 'completed', total_findings: 20 },
  { run_id: 'run-20231029-001', timestamp: '2023-10-29T08:00:00Z', status: 'running', total_findings: 0 },
];
...
export const MOCK_FINDINGS: Finding[] = [
  {
    ...
    remediation_steps: 'Set "Allow Blob Public Access" to Disabled in Configuration.',
    resource_id: '/subscriptions/sub-1/resourceGroups/rg-prod/providers/Microsoft.Storage/storageAccounts/proddata',
  ...
  },
  {
    ...
    evidence: { firewallRules: [{ name: "AllowAll", startIp: "0.0.0.0", endIp: "255.255.255.255" }] }
  },
  {
    id: 'f-103',
    run_id: 'run-20231028-001',
  ...
  },
  {
    ...
    remediation_steps: 'Reduce the number of Owner role assignments to less than 3.',
    resource_id: '/subscriptions/sub-1',
    evidence: { ownerCount: 5, owners: ["alice@corp.com", "bob@corp.com", "charlie@corp.com", "dave@corp.com", "eve@corp.com"] }
  },
  {
    id: 'f-105',
    run_id: 'run-20231028-001',
    ...
    remediation_steps: 'Restrict RDP access to specific IP ranges or use Bastion.',
