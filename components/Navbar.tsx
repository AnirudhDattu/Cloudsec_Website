...
import { ShieldCheck, LayoutDashboard, List, FileText, Zap, Bot, Settings, BookOpen } from 'lucide-react';
  ...
  return (
    <nav className="fixed top-0 left-0 h-full w-64 bg-slate-900 border-r border-slate-800 hidden md:flex flex-col z-50">
      <div className="p-6 border-b border-slate-800 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-xl tracking-wider text-white">CLOUDSEC</h1>
      ...
      <div className="p-4">
         <Link
            ...
            >
              ...
              <span className="font-medium tracking-wide text-sm">Configuration</span>
          </Link>
      </div>
      ...
      <div className="p-6 border-t border-slate-800">
        <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
          ...
          <p className="text-xs text-slate-500 font-mono">Connected to: CloudSec Node</p>
        </div>
      </div>
    </nav>
  );
