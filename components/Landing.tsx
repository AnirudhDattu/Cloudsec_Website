  ...
  return (
    <div className="min-h-screen w-full bg-cyber-950 text-slate-50 selection:bg-indigo-500/30 selection:text-white overflow-x-hidden font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            <button
              ...
              className="hover:text-cyber-cyan transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]"
            >
              Workflow
            </button>
            <button
      ...
      <section className="relative pt-40 pb-20 md:pt-52 md:pb-32 px-6 max-w-7xl mx-auto text-center z-10">
        ...
        <h1
          className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 animate-fade-in-up"
        ...
        <p
          className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up font-light"
          style={{ animationDelay: "0.3s" }}
        >
          Instant visibility into misconfigurations, risks, and compliance gaps
          across your Azure environment. Audit key services, identify
          vulnerabilities, and get actionable remediation guidance.
        </p>
        ...
        <div
          className="mt-24 relative mx-auto max-w-6xl animate-fade-in-up"
          ...
          <div className="relative glass-card rounded-xl overflow-hidden border border-white/10 shadow-2xl aspect-[16/10] md:aspect-[21/9] bg-slate-950 flex flex-col transform hover:scale-[1.01] transition-transform duration-700">
            ...
            <div className="flex-1 flex">
              ...
              <div className="w-16 border-r border-white/5 bg-slate-900/30 flex flex-col items-center py-6 gap-6">
                <div className="w-8 h-8 bg-cyan-500/20 rounded-lg text-cyan-500 flex items-center justify-center">
                  <ShieldCheck size={18} />
                </div>
                <div className="w-8 h-8 text-slate-600 flex items-center justify-center">
                  <Layers size={18} />
                </div>
                <div className="w-8 h-8 text-slate-600 flex items-center justify-center">
                  <BarChart3 size={18} />
              ...
              <div className="flex-1 p-6 md:p-10 bg-slate-950 relative">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex justify-between items-end mb-8">
                    ...
                    <div className="px-3 py-1 rounded bg-green-500/10 border border-green-500/20 text-green-400 text-xs font-bold animate-pulse">
                      LIVE SCANNING
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-8">
                    ...
                    <div className="bg-slate-900/80 border border-white/5 p-4 rounded-lg">
                      ...
                      <div className="text-xl text-orange-400 font-mono">
                        12
                      </div>
                    </div>
                    <div className="bg-slate-900/80 border border-white/5 p-4 rounded-lg">
                  ...
                  <div className="flex-1 bg-black/40 rounded-lg border border-white/10 p-4 font-mono text-xs text-slate-400 overflow-hidden relative">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-green-400">
                        <CheckCircle size={10} />{" "}
                        <span className="text-slate-300">
                          Discovering Storage Accounts (us-east-1)...
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-yellow-400 animate-pulse">
                        <AlertTriangle size={10} />{" "}
                        <span className="text-white">
                          WARNING: Public Blob Access Enabled on 'st-legacy-01'
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-green-400">
                        <CheckCircle size={10} />{" "}
                        <span className="text-slate-300">
                          Analyzing Network Security Groups...
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-red-400 animate-pulse">
                        <AlertTriangle size={10} />{" "}
                        <span className="text-white">
                          CRITICAL: RDP (3389) open to 0.0.0.0/0 on 'vm-bastion'
                        </span>
                      </div>
                    </div>
            ...
            {/* Floating Alerts */}
            {/* <div
              className="absolute top-1/4 -right-12 md:-right-16 w-64 glass-card p-4 rounded-xl border-l-4 border-l-red-500 shadow-2xl animate-fade-in-up hidden lg:block"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-400 leading-tight">
                    Unencrypted storage account detected in production resource
                    group.
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 border-y border-white/5 bg-slate-900/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight">
            One click to scan.{" "}
            <span className="text-slate-500">One dashboard to understand.</span>{" "}
            <span className="text-cyber-cyan">
              One report to fix everything.
            </span>
          </h2>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-24 px-6 bg-cyber-950 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold text-cyber-cyan tracking-widest uppercase mb-3">
              Workflow
            </h2>
            ...
            <p className="text-slate-400 mt-4 max-w-2xl mx-auto">
              We translate complex Azure security data into clean, actionable
              insights that help teams strengthen their cloud posture without
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
              {[
                {
                  title: "Scan",
                  desc: "Analyzes your Azure environment.",
                  icon: Search,
                },
                {
                  title: "Detect",
                  desc: "Misconfigurations are identified.",
                  icon: ShieldCheck,
                },
                {
                  title: "Prioritize",
                  desc: "Issues ranked by impact.",
                  icon: BarChart3,
                },
                {
                  title: "Guide",
                  desc: "Practical remediation steps.",
                  icon: CheckCircle,
                },
                {
                  title: "Track",
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-slate-900 border border-slate-700 flex items-center justify-center text-slate-400 group-hover:text-cyber-cyan group-hover:border-cyber-cyan transition-all mb-6 shadow-lg relative">
                    <step.icon size={28} />
                    <div className="absolute -bottom-3 bg-slate-950 px-2 text-xs font-mono text-slate-600">
                      0{idx + 1}
                    </div>
                  </div>
      ...
      <section
        id="capabilities"
        className="py-24 px-6 bg-slate-900/20 border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <h2 className="text-sm font-bold text-cyber-cyan tracking-widest uppercase mb-3">
            ...
            <p className="text-slate-400 max-w-3xl">
              Our platform performs a full-stack security assessment of your
              Azure resources—Storage Accounts, Virtual Machines, Function Apps,
      ...
      <section
        id="benefits"
        className="py-24 px-6 bg-cyber-950 relative overflow-hidden border-t border-white/5"
      >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              Modern cloud environments are complex and prone to
              misconfigurations. Manual checks are slow and inconsistent. We
              provide automatic, repeatable assessments aligned with industry
              best practices.
            </p>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-slate-300">
                  <div className="min-w-[20px] text-green-400">
                    <CheckCircle size={20} />
                  </div>
                  <span>{benefit}</span>
                </li>
      ...
      <section
        id="security"
        className="py-24 px-6 bg-slate-900/30 border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto mb-12">
            Built for the most demanding environments. Your data never leaves
            your secure perimeter without encryption.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-xl bg-slate-950 border border-slate-800">
              ...
              <p className="text-sm text-slate-500">
                Our infrastructure and processes are audited annually for
                security compliance.
              </p>
            </div>
            <div className="p-6 rounded-xl bg-slate-950 border border-slate-800">
              ...
              <p className="text-sm text-slate-500">
                Granular permissions ensure only authorized personnel can access
                audit reports.
              </p>
            </div>
          </div>
      ...
      <section
        id="integration"
        className="py-24 px-6 bg-cyber-950 border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="max-w-xl">
              ...
              <p className="text-slate-400 mb-8 leading-relaxed">
                Seamlessly integrate CloudSec into your existing CI/CD pipelines
                and communication tools. Get alerts where you work.
              </p>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-slate-400 mb-10">
            Reduce cloud security risks quickly and avoid costly
            misconfigurations. Start your first automated scan today.
          </p>
          <button
            onClick={handleScan}
      ...
      <footer className="py-12 border-t border-white/5 bg-black text-center">
        ...
        <p className="text-slate-600 text-sm">
          &copy; 2024 CloudSec Inc. All rights reserved.
        </p>
      </footer>
    </div>
  );
