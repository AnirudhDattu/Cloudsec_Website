...
const Reports: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        alert(
          `Report for ${selectedRun} generated successfully. In a real app, this would download the PDF.`
        );
        setGenerating(false);
      }, 1000);
    } catch (e) {
      ...
      <div className="max-w-2xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400">
            Generate detailed PDF summaries of security scans for audit and
